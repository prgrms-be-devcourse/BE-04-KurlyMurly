...
public sealed interface ProductRequest permits Create {
    record Create(
            ...
            @Schema(description = "배송 정보", allowableValues = {"EXPRESS", "NORMAL"})
            String delivery,
            ...
            @Schema(description = "상품 보관 정보", allowableValues = {"FROZEN", "REFRIGERATE", "ROOM_TEMPERATURE"})
            String storageType,
